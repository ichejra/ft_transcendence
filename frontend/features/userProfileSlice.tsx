  ...
  async (_, _api) => {
    try {
      const response = await axios.get(
        "http://192.168.99.116:3001/api/users/no_relation",
        {
          headers: {
...
export const fetchAllUsers = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get(
        "http://192.168.99.116:3001/api/users/all_users",
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
          },
...
export const fetchCurrentUser = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get("http://192.168.99.116:3001/api/users/me", {
        headers: {
          authorization: `Bearer ${Cookies.get("accessToken")}`,
        },
      });
...
export const fetchUserGameHistory = createAsyncThunk(
  ...
  async (userId: number, _api) => {
    try {
      const response = await axios.get(
        `http://192.168.99.116:3001/api/games/user/${userId}`,
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
          },
...
export const fetchUsersRank = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get(
        `http://192.168.99.116:3001/api/games/ranking`,
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
          },
...
export const enableTwoFactorAuth = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get("http://192.168.99.116:3001/api/2fa/enable", {
        headers: {
          authorization: `Bearer ${Cookies.get("accessToken")}`,
        },
      });
...
export const generate2FAQrCode = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get(
        "http://192.168.99.116:3001/api/2fa/generate",
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
          },
  ...
  async (verificationCode: string, _api) => {
    try {
      const response = await axios.post(
        "http://192.168.99.116:3001/api/2fa/first-verify",
...
export const verify2FACode = createAsyncThunk(
  ...
  async (verificationCode: string, _api) => {
    try {
      const response = await axios.post(
        "http://192.168.99.116:3001/api/2fa/verify",
...
export const disableTwoFactorAuth = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get(
        "http://192.168.99.116:3001/api/2fa/disable",
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
          },
...
export const fetchUserFriends = createAsyncThunk(
  ...
  async (_, _api) => {
    try {
      const response = await axios.get(
        "http://192.168.99.116:3001/api/users/friends",
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
          },
  ...
  async ({ data }: { data: FormData }, _api) => {
    try {
      const response = await axios.patch(
        `http://192.168.99.116:3001/api/users/update-profile`,
        data,
        {
          headers: {
            authorization: `Bearer ${Cookies.get("accessToken")}`,
