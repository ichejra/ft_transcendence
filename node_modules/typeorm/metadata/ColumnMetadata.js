...
var ColumnMetadata = /** @class */ (function () {
    ...
    ColumnMetadata.prototype.createValueMap = function (value, useDatabaseName) {
        ...
        if (this.embeddedMetadata) {
            ...
            var propertyNames = (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.embeddedMetadata.parentPropertyNames), false);
        ...
        if (this.embeddedMetadata) {
            ...
            if (embeddedObject) {
                if (this.relationMetadata && this.referencedColumn) {
                    ...
                    if (relatedEntity && relatedEntity instanceof Object && !(relatedEntity instanceof FindOperator_1.FindOperator) && !(relatedEntity instanceof Buffer)) {
                        value = this.referencedColumn.getEntityValue(relatedEntity);
                    }
                    else if (embeddedObject[this.propertyName] && embeddedObject[this.propertyName] instanceof Object && !(embeddedObject[this.propertyName] instanceof FindOperator_1.FindOperator) && !(embeddedObject[this.propertyName] instanceof Buffer) && !(embeddedObject[this.propertyName] instanceof Date)) {
            ...
            if (this.relationMetadata && this.referencedColumn) {
                ...
                if (relatedEntity && relatedEntity instanceof Object && !(relatedEntity instanceof FindOperator_1.FindOperator) && !(relatedEntity instanceof Function) && !(relatedEntity instanceof Buffer)) {
                    value = this.referencedColumn.getEntityValue(relatedEntity);
                }
                else if (entity[this.propertyName] && entity[this.propertyName] instanceof Object && !(entity[this.propertyName] instanceof FindOperator_1.FindOperator) && !(entity[this.propertyName] instanceof Function) && !(entity[this.propertyName] instanceof Buffer) && !(entity[this.propertyName] instanceof Date)) {
    ...
    ColumnMetadata.prototype.setEntityValue = function (entity, value) {
        ...
        if (this.embeddedMetadata) {
            ...
            return extractEmbeddedColumnValue_4((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(this.embeddedMetadata.embeddedMetadataTree), false), entity);
        }
        else {
